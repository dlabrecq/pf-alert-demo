	...
	var PfIcon = exports.PfIcon = function (_HTMLElement) {
	  ...
	  _createClass(PfIcon, [{
	    ...
	    value: function attachedCallback() {
	      switch (this.getAttribute("type")) {
	        case "danger":
	          this._template = this._dangerTemplate;break;
	        case "info":
	          this._template = this._infoTemplate;break;
	        case "success":
	          this._template = this._successTemplate;break;
	        case "warning":
	          this._template = this._warningTemplate;break;
	      }
